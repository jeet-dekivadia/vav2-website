...
import type { TrainingProgress } from "@/types/ml-types"
...
export function ProgressVisualization({ progress, currentEpoch, totalEpochs }: ProgressVisualizationProps) {
        ...
        <div className="grid grid-cols-2 gap-4">
          <Card>
            <CardContent className="pt-6">
              <div className="text-2xl font-bold">{progress[progress.length - 1]?.loss.toFixed(4)}</div>
              <div className="text-sm text-muted-foreground">Current Training Loss</div>
            </CardContent>
          </Card>
          <Card>
            <CardContent className="pt-6">
              <div className="text-2xl font-bold">{progress[progress.length - 1]?.validationLoss.toFixed(4)}</div>
